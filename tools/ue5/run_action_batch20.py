...
OUT = os.environ.get("BIOSHOCK_ACTION_OUT", r"C:\Users\Jack\Documents\BioShockUE5\Exports\slice\action_batch20_report.json")
try:
    import verify_action_batch20
    verify_action_batch20.main(
