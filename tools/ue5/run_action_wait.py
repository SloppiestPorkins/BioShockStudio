"""Headless driver: Phase 4 ActionWait first slice against Scripting.U schema."""
...
OUT = os.environ.get(
    "BIOSHOCK_ACTION_OUT",
    r"C:\Users\Jack\Documents\BioShockUE5\Exports\slice\action_wait_report.json")

result = {"error": None}
try:
    import verify_action_wait
    result = verify_action_wait.main(SCHEMA, OUT)
