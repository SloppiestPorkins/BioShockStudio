...
OUT = os.environ.get("BIOSHOCK_ACTION_OUT", r"C:\Users\Jack\Documents\BioShockUE5\Exports\slice\action_batch16_report.json")
try:
    import verify_action_batch16
    verify_action_batch16.main(
