class ActionGetNumQuestObjectivesCompleted extends ActionQuestBase
	editinlinenew
	collapsecategories
...
function Variable execute()
{
	...
	return newTemporaryVariable(Class'Scripting.VariableFloat', string(ShockPlayer(parentScript.Level.GetLocalPlayerController().Pawn).GetQuest(QuestName).NumberOfObjectivesCompleted));
	return;
	@NULL
	Item
	Item
