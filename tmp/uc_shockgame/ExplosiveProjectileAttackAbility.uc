class ExplosiveProjectileAttackAbility extends ProjectileAttackAbility implements IProvideExplosiveProjectileDamageData
	abstract
	config(Abilities);
...
defaultproperties
{
	...
	DamageStimuliSetName="AutoGenerated"
