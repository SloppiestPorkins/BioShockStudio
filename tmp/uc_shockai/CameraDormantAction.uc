class CameraDormantAction extends BioshockCharacterAction
	collapsecategories
...
{Begin:
	...
	log('AI_Security', 4, __NFUN_112__(string(m_Pawn), " starting CameraDormantAction::Running."));
	MyCamera.SetDormant();
...
defaultproperties
{
	satisfiesGoal=Class'ShockAI.CameraDormantGoal'
}