...
|---|---|---|---|
| Codex | **Gate 0 item 3**: resolve baked-light atlas RGB semantics from shipped bytes and rendered evidence; do not enable by default until the picture is correct | `src/BioShockStudio.Core/Level/`, `tests/BioShockStudio.Tests/*Lightmap*`, `docs/research/bsp.md`, `docs/ROADMAP.md` | 23 Aug 2026 |
