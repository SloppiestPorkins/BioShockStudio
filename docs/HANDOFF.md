...
| Cursor (this session) | **ActionBlockingExecuteScript** (census #20) next. Vision+Hearing landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
