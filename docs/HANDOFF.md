...
**Recently released:** ActionGiveItemsToPlayer in-world (`run_script_inventory_ui.py`, ammo stack 3, `Success - 0 error(s)` 28 Aug 2026). ActionAttackTarget in-world. Game-mode possess on 1-Medical (`run_game_possess.py`).
