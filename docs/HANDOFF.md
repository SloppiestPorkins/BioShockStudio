...
| Cursor (this session) | **ActionPlayAnimation** (census #12) next. StopEffect landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
