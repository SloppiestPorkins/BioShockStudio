...
| Cursor (this session) | **ActionTweakAIVision** (census #18) next. ChangeCollision landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, ShockAI | 26 Aug 2026 |
