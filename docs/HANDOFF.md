...
| Cursor (this session) | **ActionSpawnAI** (census #10). HideOrShowActor landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U / ShockAI | 26 Aug 2026 |
