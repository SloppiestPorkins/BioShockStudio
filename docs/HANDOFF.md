...
|---|---|---|---|
| Codex | **Gate 3 item 3**: region/volume actor schemas in shipped-count order, starting with Medical `BlockingVolume` | `src/BioShockStudio.Core/Level/`, `src/BioShockStudio.Core/Export/LevelSceneExporter.cs`, `tests/BioShockStudio.Tests/*Actor*Tests.cs`, `docs/ROADMAP.md`, `docs/research/bsp.md` | 23 Aug 2026 |
