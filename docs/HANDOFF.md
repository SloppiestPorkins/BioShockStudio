...
| Cursor (this session) | **ActionChangeCollision** (census #17) next. GiveItems landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
