...
| Cursor (this session) | **ActionScriptNote** + **ActionDestroyActor** (census #13–14). PlayAnimation landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
