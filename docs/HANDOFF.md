...
| Composer (this session) | **Gate 4 item 4** — `ScriptedSequence` decode **landing**. KeyPos/KeyRot still deferred. No Task/backup-agent. | `src/BioShockStudio.Core/Level/`, `Export/LevelSceneExporter.cs`, `tests/.../ScriptedSequenceActorSchemaTests.cs` | 25 Aug 2026 |
