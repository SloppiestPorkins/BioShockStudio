...
| Cursor (this session) | **Gate 5 Phase 1.4 lighting mapping — landed.** Live UE5.7: 664 Medical PointLights, authored brightness/radius, inverse-square off, 28 dropped (no radius). Next: Phase 1 remaining is material graphs / TextureCube (both UNKNOWN — do not invent) or the vertical slice. No Task/backup-agent. | `tools/ue5/import_level.py`, `tools/ue5/{verify_light_import,run_light_look}.py` | 25 Aug 2026 |
