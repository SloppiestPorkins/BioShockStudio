...
| Cursor (this session) | **Playable-slice code-only** — stand-ins + batch20 wired on disk, **UE verify pending**. No UAT while user games. | `tools/ue5/BioShockRuntime/` ShockPawn/Weapon/Player, SpawnAI, batch20 | 26 Aug 2026 |
