...
| Cursor (this session) | **ActionHideOrShowActor** (census #9). VariableAssign landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
