...
| Cursor (this session) | **ActionAttackTarget** (census #15) next. ScriptNote+Destroy landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, ShockAI | 26 Aug 2026 |
