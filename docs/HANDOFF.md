...
| Cursor (this session) | **ActionVariableAssign** (census #8). AssignIfNotExist landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
