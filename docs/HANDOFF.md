...
| Cursor (this session) | **ActionVariableAssignIfNotExist** (census #7). SetLightProperties landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
