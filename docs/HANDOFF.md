...
| Cursor (this session) | **ActionSetLightProperties** (census #6). NonBlockingExecuteScript landed. No Task/backup-agent. | `tools/ue5/BioShockRuntime/` Action*, Scripting.U | 26 Aug 2026 |
